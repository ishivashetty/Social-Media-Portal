...
<body>
	...
	<div class="col-lg-3">
		...
		<div class="panel panel-default col-md-8"
			...
			<hr>
			<div class="well">
			<a href="AddDonation.jsp" class="btn btn-primary">Donate</a>
			</div>
			...
			<div class="well">
			<a href="ShowAllCards.jsp" class="btn btn-primary">Show Cards</a>
			</div>
			
			<div class="well">
				<a href="AddEventSubscription.jsp" class="btn btn-primary">Subscribe</a>
			</div>
