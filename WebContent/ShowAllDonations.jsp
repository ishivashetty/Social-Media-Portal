...
<div class="col-lg-3"></div>
   <%
       ArrayList<Donation> list = DonationWorker.getAllDonations();
   %>   
   ...
   %>
   <tr>
       <td><%=donation.getMemberId() %></td>

           <th><%=donation.getAmount()%></th>
           <th><%=donation.getTime()%></th>
           <th><%=donation.getPaymentMode()%></th>   </tr>	
   <%
   }
   %>
</table>
...
<div class="well" align="center">
<span class="h2">Total Donations</span><hr>
<span class="h3">Rs. <%=DonationWorker.getTotalDonation()%></span>
</div>
<script src="src/js/jquery.min.js"></script>
